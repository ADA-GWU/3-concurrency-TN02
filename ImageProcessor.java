...
public class ImageProcessor {
    ...
    public static void initialize(String fileName, int squareSize, String processingMode) {
        try {
    ...
    private static void processImage(int squareSize, String processingMode) {
        ...
        try {
            ...
            // Save the result image after all threads finish
    ...
    private static int calculateAvg(ArrayList<Integer> numbers) {
        int total = 0;
